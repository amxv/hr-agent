...
!`gg ctx --spec --featureid $ARGUMENTS`
...
If the feature exists, proceed with the following steps:

1. First, carefully read the spec file provided.
...
4. Spawn parallel researcher sub-agents (max 5) for every question:
...
6. Web Research for External Packages and Framework Features:
