...
### Key Technologies:
- **ORM**: Drizzle ORM v0.34.0 (`/Users/ashray/code/amxv/rag/lib/db/schema.ts`)
- **Migration Tool**: Drizzle Kit v0.25.0 (`drizzle.config.ts`)
- **Database**: PostgreSQL
- **Connection Driver**: postgres v3.4.4
- **Migration Runner**: Custom script (`/Users/ashray/code/amxv/rag/lib/db/migrate.ts`)

---

## Architecture Overview

### 1. Configuration (`/Users/ashray/code/amxv/rag/drizzle.config.ts`)
...
### 2. Database Connection (`/Users/ashray/code/amxv/rag/lib/db/client.ts`)
...
### 3. Migration Runner (`/Users/ashray/code/amxv/rag/lib/db/migrate.ts`)
...
### Main Schema File (`/Users/ashray/code/amxv/rag/lib/db/schema.ts`)
...
**Path:** `/Users/ashray/code/amxv/rag/lib/db/migrations/`
...
### Migration Metadata (`/Users/ashray/code/amxv/rag/lib/db/migrations/schema.ts`)
...
**File:** `/Users/ashray/code/amxv/rag/lib/db/migrations/0003_cloudy_glorian.sql`
...
**File:** `/Users/ashray/code/amxv/rag/lib/db/migrations/0020_strange_senator_kelly.sql`
...
**File:** `/Users/ashray/code/amxv/rag/lib/db/migrations/0025_keen_blackheart.sql` (87 lines)
...
**File:** `/Users/ashray/code/amxv/rag/lib/db/migrations/0010_wide_invisible_woman.sql`
...
Modify `/Users/ashray/code/amxv/rag/lib/db/schema.ts`:
...
From `/Users/ashray/code/amxv/rag/package.json` lines 12-18:
...
### From `/Users/ashray/code/amxv/rag/lib/db/queries.ts`
...
### Configuration Files
- `/Users/ashray/code/amxv/rag/drizzle.config.ts` - Drizzle Kit configuration
- `/Users/ashray/code/amxv/rag/package.json` - npm scripts and dependencies

### Schema & Migrations
- `/Users/ashray/code/amxv/rag/lib/db/schema.ts` - TypeScript schema definitions (199 lines)
- `/Users/ashray/code/amxv/rag/lib/db/migrations/schema.ts` - Migration schema metadata
- `/Users/ashray/code/amxv/rag/lib/db/migrations/` - SQL migration files (26 total)

### Database Operations
- `/Users/ashray/code/amxv/rag/lib/db/client.ts` - Database connection client
- `/Users/ashray/code/amxv/rag/lib/db/migrate.ts` - Migration runner script (33 lines)
- `/Users/ashray/code/amxv/rag/lib/db/queries.ts` - Query functions with patterns

### Example Migrations
- `/Users/ashray/code/amxv/rag/lib/db/migrations/0003_cloudy_glorian.sql` - Simple ADD COLUMN
- `/Users/ashray/code/amxv/rag/lib/db/migrations/0020_strange_senator_kelly.sql` - ADD with UPDATE
- `/Users/ashray/code/amxv/rag/lib/db/migrations/0025_keen_blackheart.sql` - Complex restructuring (87 lines)
- `/Users/ashray/code/amxv/rag/lib/db/migrations/0010_wide_invisible_woman.sql` - CREATE TABLE with FKs
